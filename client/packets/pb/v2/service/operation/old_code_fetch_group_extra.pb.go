...
// source: service/operation/old_code_fetch_group_extra.proto
...
type FetchGroupExtraRequestConfigFlags struct {
	...
	LatestMessageSequence proto.Option[bool]   `protobuf:"varint,22,opt"`
...
type FetchGroupExtraResponseInfoResult struct {
	GroupOwner            proto.Option[string] `protobuf:"bytes,1,opt"`
	...
	GroupName             proto.Option[string] `protobuf:"bytes,15,opt"`
	GroupMemo             proto.Option[string] `protobuf:"bytes,16,opt"`
	GroupUin              proto.Option[uint32] `protobuf:"varint,21,opt"`
	LatestMessageSequence proto.Option[int64]  `protobuf:"varint,22,opt"`
