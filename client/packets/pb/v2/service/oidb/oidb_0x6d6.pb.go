...
// source: service/oidb/oidb_0x6d6.proto
...
type DeleteFileReqBody struct {
	...
	MsgdbSeq       proto.Option[uint32] `protobuf:"varint,6,opt"`
	MsgRand        proto.Option[uint32] `protobuf:"varint,7,opt"`
	_              [0]func()
}
...
type DownloadFileReqBody struct {
	...
	ThumbnailReq proto.Option[bool]   `protobuf:"varint,5,opt"`
	UrlType      proto.Option[uint32] `protobuf:"varint,6,opt"`
	PreviewReq   proto.Option[bool]   `protobuf:"varint,7,opt"`
	Src          proto.Option[uint32] `protobuf:"varint,8,opt"`
	_            [0]func()
}
...
type DownloadFileRspBody struct {
	...
	DownloadDns      proto.Option[string] `protobuf:"bytes,5,opt"`
	...
	PreviewPort      proto.Option[uint32] `protobuf:"varint,12,opt"`
	DownloadDnsHttps proto.Option[string] `protobuf:"bytes,13,opt"`
	PreviewPortHttps proto.Option[uint32] `protobuf:"varint,14,opt"`
}
...
type UploadFileReqBody struct {
	...
	AppId              proto.Option[uint32] `protobuf:"varint,2,opt"`
	BusId              proto.Option[uint32] `protobuf:"varint,3,opt"`
	Entrance           proto.Option[uint32] `protobuf:"varint,4,opt"`
	ParentFolderId     proto.Option[string] `protobuf:"bytes,5,opt"`
	...
	SupportMultiUpload proto.Option[bool]   `protobuf:"varint,12,opt"`
}
