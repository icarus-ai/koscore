...
// source: service/oidb/old_code_oidb_0xbcb_0.proto
...
type CheckUrlReq struct {
	...
	Type        proto.Option[uint32] `protobuf:"varint,5,opt"` // 15
	From        proto.Option[uint32] `protobuf:"varint,6,opt"`
	ChatId      proto.Option[uint64] `protobuf:"varint,7,opt"`
	ServiceType proto.Option[uint64] `protobuf:"varint,8,opt"` // 1
